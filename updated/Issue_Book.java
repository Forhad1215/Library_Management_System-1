...
public class Issue_Book extends JFrame {
    ...
    Issue_Book(){
        ...
        bokidTextField.setBounds(370, 90, 220, 40);
        add(bokidTextField);
        
        JButton search = new JButton("Search");
        search.setBackground(new Color(198,189,189));
        search.setForeground(Color.BLACK);
        search.setBounds(590, 90, 80, 40);
        add(search);
        ...
        JDateChooser isdat = new JDateChooser();
        isdat.setBounds(370, 270, 300, 40);
        add(isdat);
